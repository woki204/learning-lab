...
| שאלות | שאלה אמריקאית (רשימה או כרטיסים עם תמונות, או סקר עמדה ללא תשובה נכונה) · בחירה מרובה · השלמת מילים (הקלדה או רשימה נפתחת) · מיון לקבוצות · שאלה פתוחה |
| כרטיסים | תיבות מסומנות (הידעת · טיפ · גוף ידע · כלי חדש · מילה חמה · שימו לב) · כרטיס כלי · כרטיס מקור |
